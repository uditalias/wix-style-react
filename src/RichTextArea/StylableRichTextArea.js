...
import RichTextEditorToolbar from './StylableRichTextAreaToolbar';
...
@stylable(styles)
export default class RichTextArea extends WixComponent {
  static propTypes = {
  ...
  render() {
    ...
    return (
      <div style-state={{withError: error, isFocused: editorState.isFocused}} data-hook={dataHook}>
        <div style-state={{disabled}} className="toolbar">
        ...
        <div
          style-state={{resizable, scrollable: isScrollable, disabled}}
  ...
  renderError = () => {
    ...
    return (
      <Tooltip
        ...
        theme="dark"
        >
        <div className="exclamation"><SvgExclamation width={2} height={11}/></div>
      </Tooltip>
    );
  };
}
